...
const Highlights: React.FC = () => {
  return (
    <section className="h-full w-full bg-[#fff] bg-[url('/images/home/hero/bg.png')] bg-cover bg-center bg-no-repeat px-4 py-8 md:px-20">
      <div className="flex h-full w-full flex-col items-center justify-center gap-6 md:items-end md:gap-10">
        <div className="flex flex-col items-center justify-center gap-4 md:mr-32 md:flex-row md:gap-32">
          <h6
            className="text-center font-cinzel text-5xl font-[400] uppercase text-[#fff] md:mb-8 md:text-7xl md:tracking-[-1px]"
            // style={{
        ...
        {/* <div className="flex h-full w-full flex-col gap-8 md:flex-row">
          <div className="flex w-full flex-col items-center justify-center gap-6 md:w-[33%]">
            ...
            <h6 className="text-center font-cinzel text-2xl font-[500] uppercase text-[#fff] md:text-3xl md:tracking-[-1px]">
              Ambience
            </h6>
          </div>
          <div className="flex w-full flex-col items-center justify-center gap-6 md:w-[33%]">
