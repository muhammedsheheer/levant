            ...
            <Carousel className="ml-6 mr-0 w-full md:ml-0 md:mr-12">
              <CarouselContent className="flex w-full justify-center gap-4 md:ml-4">
                {reviews.map((review, index) => (
                  <CarouselItem
                    key={index}
                    className={`flex w-full basis-full flex-col items-center justify-center gap-6 rounded-none py-6 md:basis-1/3 md:py-12 ${index % 2 === 0 ? "bg-[#638D39] text-[#fff]" : "bg-[#D9D9D9] text-[#000]"}`}
                  >
                    <div className="flex flex-col gap-6 bg-transparent px-6 pb-4">
                      <div className="flex w-full justify-center">
                        {Array.from({ length: review.rating }).map(
                      ...
                      <div className="flex flex-col gap-4">
                        <p
                          className={`font-poppins line-clamp-6 w-full max-w-[350px] text-center text-sm font-[500] uppercase tracking-[2px] md:px-4 lg:leading-[120%] ${index % 2 === 0 ? "text-[#fff]" : "text-[#000]"}`}
                        >
                          {review.text}
                        </p>
                      </div>
